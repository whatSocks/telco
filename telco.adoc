...
CREATE (`1`:crew:subgraph {crew_id:1, name:'Abeer Fathy'}), (`2`:crew:subgraph {crew_id:2, name:'An Yu-bao'}), (`3`:crew:subgraph {crew_id:3, name:'Anastasiya Vasilyev'}), (`4`:crew:subgraph {crew_id:4, name:'Anna Zaytesev'}), (`5`:crew:subgraph {crew_id:5, name:'Asley Leger'}), (`6`:crew {crew_id:6, name:'Aziza Hsuang-tsung'}), (`7`:crew {crew_id:7, name:'Bai Vasilyev'}), (`8`:crew {crew_id:8, name:'Barbra Schon'}), (`9`:crew {crew_id:9, name:'Bart Kosana'}), (`10`:crew {crew_id:10, name:'Bill Hinzman'}), (`11`:crew {crew_id:11, name:'Bill Cardille'}), (`12`:crew {crew_id:12, name:'Bobba Fett'}), (`13`:crew {crew_id:13, name:'Cai Shen'}), (`14`:crew:service {crew_id:14, name:'Cammy Schott'}), (`15`:crew {crew_id:15, name:'Cammy Vinogradov'})
