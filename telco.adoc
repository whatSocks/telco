...
CREATE (`1`)-[:KNOWS]->(`2`), (`1`)-[:KNOWS]->(`4`), (`1`)-[:KNOWS]->(`3`), (`2`)-[:KNOWS]->(`1`), (`2`)-[:KNOWS]->(`3`), (`2`)-[:KNOWS]->(`4`), (`3`)-[:KNOWS]->(`1`), (`3`)-[:KNOWS]->(`2`), (`3`)-[:KNOWS]->(`5`), (`4`)-[:KNOWS]->(`2`), (`4`)-[:KNOWS]->(`1`), (`4`)-[:KNOWS]->(`5`), (`5`)-[:KNOWS]->(`3`), (`5`)-[:KNOWS]->(`4`), (`14`)-[:KNOWS]->(`13`),(`14`)-[:KNOWS]->(`8`),(`14`)-[:KNOWS]->(`7`),(`7`)-[:KNOWS]->(`6`),(`8`)-[:KNOWS]->(`9`),(`13`)-[:KNOWS]->(`10`),(`10`)-[:KNOWS]->(`11`),(`10`)-[:KNOWS]->(`12`)
----
//graph
