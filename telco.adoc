...
CREATE (`1` :subgraph:resource {resource_id:1, name:'Abeer'}), (`2` :subgraph:crew {resource_id:2, name:'An'}), (`3` :subgraph:crew {resource_id:3, name:'Anastasiya'}), (`4` :subgraph:crew {resource_id:4, name:'Anna'}), (`5` :subgraph:crew {resource_id:5, name:'Asley'}), (`6`:crew {resource_id:6, name:'Aziza'}), (`7`:crew {resource_id:7, name:'Bai'}), (`8`:crew {resource_id:8, name:'Barbra'}), (`9`:crew {resource_id:9, name:'Bart'}), (`10`:crew {resource_id:10, name:'Bill'}), (`11`:crew {resource_id:11, name:'Bill'}), (`12`:crew {resource_id:12, name:'Bobba'}), (`13`:crew {resource_id:13, name:'Cai'}), (`14` :service {service_id:1, name:'STS'}), (`15`:crew {resource_id:15, name:'Cammy'})
